...
Standard regression techniques allow the researcher to determine
the effect of covariates $X$ on the expected value of a response
variable $Y$. In contrast, quantile regressions are capable of characterizing how
changes in $X$ affect the entire conditional distribution of $Y$. In applied
