...
- `parallel`: request the estimation of bootstrap standard errors to be performed using `parallel` package (@vegayon2019)
...
- `robust` and `cluster(varname)`: These options are available when using `mmqreg` estimator. They follow the derivations from  @riosavila2024, based on robust and cluster standard errors for gmm estimators..
