...
which quantile regressions leverage, leading to inconsistent estimates
of all parameters.\footnote{This is similar to the measuring error
  problem of dependent variables in quantile regression models discussed
  in \citet{hausman2021}.}
...
use bootstrap methods for the estimation of the standard errors.
...
from zero, the model is heteroskedastic, and quantile regression could
be used to identify this type of unobserved heterogeneity. Lastly, if a
...
the heterogeneous effect of the covariates, as deviation from the
